...
→**Backend**: Java, Object-Oriented Programming, JDBC, Business Logic, Service Classes
→**Database**: MySQL, JDBC, SQL Queries, Foreign Keys, BLOB
→**Data Structures & Algorithms**: Binary Search Tree (BST), ArrayList, Recursive Searching, Tree Traversal
...
# Database Tables
→items – stores item name, price, and quantity
